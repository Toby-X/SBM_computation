...
source("./utils.r")
source("./methods/spectral_l2.R")
source("./metrics.r")

train_sl2 <- function(N, K, beta, b, seed){
  # generate data
                                    ...
                                    for (b in b_list) {
                                      for (K in K_list) {
                                        for (beta in beta_list) {
                                          res <- rbind(res, train_sl2(N, K, beta, b, i))
                                        }
                                      }
                                    }
                                  }
